        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (selectRow == -1)
                {
                    ...
                    this.luongTableAdapter.Them(comboBox1.Text,comboBox3.Text,comboBox2.Text,textBox1.Text, double.Parse(textBox11.Text),int.Parse(textBox14.Text),int.Parse(textBox12.Text),textBox2.Text,textBox3.Text);
                    this.luongTableAdapter.Fill(this.thongTinTaiKhoan.Luong);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.luongTableAdapter.Sua(comboBox1.Text, comboBox3.Text, comboBox2.Text, textBox1.Text, double.Parse(textBox11.Text), int.Parse(textBox14.Text), int.Parse(textBox12.Text), textBox2.Text, textBox3.Text, comboBox2.Text);
                    this.luongTableAdapter.Fill(this.thongTinTaiKhoan.Luong);
