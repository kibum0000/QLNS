...
namespace Đồ_Án_QL_Nhân_Sự
{
    public partial class FormPhongbankhoa : Form
    {
        ...
        private int GetSelectedRow(string studentID)
        {
            ...
            {
                if (phongDataGridView.Rows[i].Cells[1].Value.ToString() == studentID)
                {
                    return i;
                }
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                int selectRow = GetSelectedRow(textBox2.Text);
                if (selectRow == -1)
                {
                    this.phongTableAdapter.them(mã_Bộ_PhậnComboBox.Text, textBox2.Text, textBox3.Text, dateTimePicker1.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.phongTableAdapter.Sua(mã_Bộ_PhậnComboBox.Text, textBox2.Text, textBox3.Text, dateTimePicker1.Text, textBox2.Text);
                    this.phongTableAdapter.Fill(this.thongTinTaiKhoan.Phong);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.phongTableAdapter.xoa(textBox2.Text);
                    this.phongTableAdapter.Fill(this.thongTinTaiKhoan.Phong);
