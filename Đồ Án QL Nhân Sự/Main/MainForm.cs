using Đồ_Án_QL_Nhân_Sự.Chức_Năng;
using System;
...
namespace Đồ_Án_QL_Nhân_Sự
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            InitializeComponent();
            //Để thời gian bắt đầu chạy
            timer1.Start();
        }

        private void quảnLýTàiKhoảnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //Tạo form mới và đưa vào Panel cho hiện lên
        ...
        {
            //Tạo form đăng nhập mới , ẩn main và hiện form đăng nhập kiểu Dialog
        ...
        {
            //nếu chưa đăng nhập thì sẽ hiện form Start còn đăng nhập rồi thì hiện form chào
            if (quyen == null)
            {
            ...
            if (quyen == "Admin")
            {
                ...
                chếĐộToolStripMenuItem.Enabled = true;
            }
            else if (quyen == "User")
            {
                DanhMuc.Enabled = true;
